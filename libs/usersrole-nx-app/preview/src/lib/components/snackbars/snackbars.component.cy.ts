...
describe(SnackbarsComponent.name, () => {
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [BrowserAnimationsModule],
    }).overrideComponent(SnackbarsComponent, {
      add: {
...
function testScreenSize(name: string, width: number, height: number) {
  describe(name, () => {
    beforeEach(() => {
