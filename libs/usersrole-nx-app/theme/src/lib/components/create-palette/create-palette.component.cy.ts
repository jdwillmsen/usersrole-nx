...
describe(CreatePaletteComponent.name, () => {
  beforeEach(() => {
    TestBed.overrideComponent(CreatePaletteComponent, {
      add: {
        imports: [],
        providers: [],
      },
  ...
  describe('Setup Properly', () => {
    it('should be setup properly for primary properties', () => {
      cy.mount(CreatePaletteComponent, {
        providers: [
          {
            provide: FormGroupDirective,
    ...
    it('should be setup properly for accent properties', () => {
      cy.mount(CreatePaletteComponent, {
        providers: [
          {
            provide: FormGroupDirective,
    ...
    it('should be setup properly for info properties', () => {
      cy.mount(CreatePaletteComponent, {
        providers: [
          {
            provide: FormGroupDirective,
    ...
    it('should be setup properly for error properties', () => {
      cy.mount(CreatePaletteComponent, {
        providers: [
          {
            provide: FormGroupDirective,
    ...
    it('should be setup properly for success properties', () => {
      cy.mount(CreatePaletteComponent, {
        providers: [
          {
            provide: FormGroupDirective,
    ...
    it('should be setup properly for warn properties', () => {
      cy.mount(CreatePaletteComponent, {
        providers: [
          {
            provide: FormGroupDirective,
